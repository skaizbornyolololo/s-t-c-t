...
module.exports = new Command({
	name: "youtubedev",
	description: "Xem YoutubeDev cùng bạn bè trên Discord!",
	...
	async run(client, message, args) {
        ...
        client.discordTogether.createTogetherCode(voiceChannel.id, 'youtubeDev').then(async invite => {
            ...
            message.channel.send({ content: "Click bên dưới để bắt đầu xem!", components: [row]})
        });
	}
});
