...
module.exports = new Command({
	name: "chessdev",
	description: "Chơi cờ vua phiên bản dành cho developer cùng bạn bè trên Discord!",
	...
	async run(client, message, args) {
        ...
        client.discordTogether.createTogetherCode(voiceChannel.id, 'chessDev').then(async invite => {
